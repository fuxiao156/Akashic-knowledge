...
export const isArticleResource = (resource: IResource<any>): resource is IResource<TArticle> => {
    return resource.type === 'article';
}

export const isFileResource = (resource: IResource<any>): resource is IResource<TFile> => {
    return resource.type === 'file';
}

export const isMediaResource = (resource: IResource<any>): resource is IResource<TMedia> => {
